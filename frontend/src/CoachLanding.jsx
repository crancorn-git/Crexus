...
export default function CoachLanding({ onBack, onScoutClick }) {
  return (
    <div className="crexus-page">
      ...
      <div className="crexus-card mt-5 rounded-2xl p-6 md:p-8">
        <div className="text-[11px] font-black uppercase tracking-[0.24em] text-red-300">v0.8 Coaching Layer</div>
        <h1 className="mt-3 text-4xl font-black tracking-tight text-white md:text-5xl">Cranix Scout Coach</h1>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-400 md:text-base">Search a player first, then open the Coach tab on their profile. Cranix Scout will turn their recent games into strengths, weaknesses, role-specific advice, and match review notes.</p>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-3">
        {[
          ['Cranix Scout Coach', '3 strengths, 3 weaknesses, recommended focus, champion pool advice, lane phase advice, and objective advice.'],
          ...
          <div key={title} className="rounded-2xl border border-white/10 bg-[#101116] p-5">
