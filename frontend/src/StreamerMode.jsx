    ...
    <div className="min-h-screen bg-transparent p-4 text-gray-100">
      <div className="w-[420px] rounded-[30px] border border-red-500/30 bg-[#090a0e]/92 p-5 shadow-[0_0_45px_rgba(239,68,68,0.28)] backdrop-blur">
        <div className="flex items-center gap-3">
          <img src="/cranix-scout-logo.png" alt="Cranix Scout" className="h-11 w-11 rounded-2xl object-contain" />
          <div>
            <div className="text-[10px] font-black uppercase tracking-[0.22em] text-red-300">Cranix Scout Player Card</div>
