  ...
  return (
    <div className="crexus-card mb-8 rounded-[28px] p-5 md:p-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          <div className="text-[10px] font-black uppercase tracking-[0.24em] text-red-300">v0.6 Enemy Matchup Read</div>
...
export function DuoSynergyRead({ participants = [] }) {
  ...
  return (
    <div className="crexus-card mb-8 rounded-[28px] p-5 md:p-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          <div className="text-[10px] font-black uppercase tracking-[0.24em] text-red-300">v0.6 Duo / Synergy Detection</div>
